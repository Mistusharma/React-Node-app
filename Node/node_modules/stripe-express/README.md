...
Deprecated: Please use 'stripe-client' instead, it's the updated version of the same package under a different name :) React Native Stripe wrapper that makes using Stripe with React Native easy in iOS/Android.
